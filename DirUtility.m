...
//  Version 1.6.4
//
//  Created by Kalpit Gajera on 10/12/2015.
//  Copyright (C) 2012 Kalpit Gajera
//
//  Distributed under the permissive zlib License
//  Get the latest version from here:
//
//  https://github.com/nicklockwood/DirUtility
//
...
@implementation NSFileManager (DirUtility)
...
@implementation NSString (DirUtility)
...
@implementation NSString (DirUtility_Deprecated)
...
@implementation UIImage (DirUtility)
...
@implementation NSBundle (DirUtility)
...
@implementation UINib (DirUtility)
...
@implementation UIViewController (DirUtility)
...
@implementation NSImage (DirUtility)
